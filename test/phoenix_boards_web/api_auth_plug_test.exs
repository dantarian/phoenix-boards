defmodule PhoenixBoardsWeb.APIAuthPlugTest do
  use PhoenixBoardsWeb.ConnCase
  doctest PhoenixBoardsWeb.APIAuthPlug

  alias PhoenixBoardsWeb.{APIAuthPlug, Endpoint}
  alias PhoenixBoards.{Repo, Users.User}
  alias Plug.Conn

  @pow_config [otp_app: :phoenix_boards]
